...
public class VideosFireBaseAdapter extends FirebaseRecyclerAdapter<VideoModel1, VideosFireBaseAdapter.MyHolder> {
    ...
    public VideosFireBaseAdapter(@NonNull FirebaseRecyclerOptions<VideoModel1> options) {
        super(options);
    }
    ...
    private void handleLikes(@NonNull MyHolder holder, @NonNull VideoModel1 model, String videoKey) {
